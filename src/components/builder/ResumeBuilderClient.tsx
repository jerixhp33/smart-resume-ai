...
export function ResumeBuilderClient({ resume, versions, userId }: ResumeBuilderClientProps) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden -m-4 sm:-m-6 lg:-m-8">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className={`
          w-[420px] flex-shrink-0 border-l border-border bg-card overflow-y-auto
          ${mobileView === 'preview' ? 'flex' : 'hidden'} lg:flex flex-col
        `}>
